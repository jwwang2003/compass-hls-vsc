...
import { addDefaultInitializers } from './addDefaultInitializers';
import { removeCCommentsFromFile } from './removeCComments';
import { generateYamlFromCFile } from './generateYamlFromCFile';
...
export function main({
    ...
    fs.writeFileSync(tmp1, addDefaultInitializers(source, expandMacros), 'utf-8');
    // 2. 删除注释
